...
public class RectPacker
{
    ...
    public int PackedAreaWidth => actualPackingAreaWidth;
    public int PackedAreaHeight => actualPackingAreaHeight;
    ...
    public RectPacker(int packingAreaWidth, int packingAreaHeight)
    {
    ...
    private bool isFree(ref PackingRectangle rectangle, int testedPackingAreaWidth, int testedPackingAreaHeight)
    {
